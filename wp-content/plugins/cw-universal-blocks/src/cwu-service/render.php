...
$logoUrl = "cwu-service/{$selectedMarket}-favicon";
?>
    ...
    <div class="grid-container">
        ...
        <div class="cwu-service__table">
            <div class="cwu-service__row cwu-service__row--header">
                ...
                <div class="cwu-service__row--centr-item">
                    <?php echo cwu_get_responsive_image($logoUrl, 'logo', 'cwu-service__row--icon'); ?>
                    <div class="cwu-service__row--text">Selling with <?php echo esc_html($selectedName); ?></div>
                </div>
            ...
            <div class="cwu-service__row">
                ...
                <div class="cwu-service__row--centr-item">
                    <?php echo cwu_get_responsive_image('cwu-service/icon-ok', 'Icon', 'cwu-service__row--icon'); ?>
                    <div class="cwu-service__row--text">NONE</div>
                </div>
                <div class="cwu-service__row--right-item">
                    <?php echo cwu_get_responsive_image('cwu-service/icon-not', 'Icon', 'cwu-service__row--icon'); ?>
        ...
        <div class="cwu-service__footer">
            ...
            <div class="cwu-service__footer-block">
                <a class="cwu-service__cta cta-btn green-btn green-btn--arrow" href="#cwu-form">Get my offer</a>
                <div class="cwu-hero__reviews">
                    <div class="cwu-hero__reviews-stars-wrapper">
                        <span class="cwu-hero__star"><?php echo cwu_get_responsive_image('cwu-service/star', 'star'); ?></span>
                        <span class="cwu-hero__star"><?php echo cwu_get_responsive_image('cwu-service/star', 'star'); ?></span>
                        <span class="cwu-hero__star"><?php echo cwu_get_responsive_image('cwu-service/star', 'star'); ?></span>
                        <span class="cwu-hero__star"><?php echo cwu_get_responsive_image('cwu-service/star', 'star'); ?></span>
                        <span class="cwu-hero__star"><?php echo cwu_get_responsive_image('cwu-service/star', 'star'); ?></span>
