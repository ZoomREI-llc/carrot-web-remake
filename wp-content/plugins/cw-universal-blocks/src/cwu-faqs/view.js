...
function loadCallback() {
	const faqs = document.querySelectorAll(".cwu-faqs__item");

	faqs.forEach((faq) => {
		const question = faq.querySelector(".cwu-faqs__question");
		const answer = faq.querySelector(".cwu-faqs__answer");
		const indicator = question.querySelector(".cwu-faq-indicator");
		...
		question.addEventListener("click", () => {
			...
			faqs.forEach((otherFaq) => {
				if (otherFaq !== faq) {
					const otherQuestion = otherFaq.querySelector(".cwu-faqs__question");
					const otherAnswer = otherFaq.querySelector(".cwu-faqs__answer");
					const otherIndicator = otherFaq.querySelector(".cwu-faq-indicator");
	...
	// 	const firstQuestion = firstFaq.querySelector(".cwu-faqs__question");
	// 	const firstAnswer = firstFaq.querySelector(".cwu-faqs__answer");
	// 	const firstIndicator = firstFaq.querySelector(".cwu-faq-indicator");
	//
