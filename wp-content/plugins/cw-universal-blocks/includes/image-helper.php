...
function cwu_get_responsive_image($image_name, $alt = '', $class = '', $sizes_attr = '', $extension = 'webp', $default_size = 300)
{
 ...
 */
function cwu_get_image_url($image_name, $size = null, $extension = 'webp')
{
    $base_url = plugin_dir_url(__DIR__) . 'optimized-assets/';
    $base_dir = plugin_dir_path(__DIR__) . 'optimized-assets/';
