...
/*!****************************************************!*\
  !*** ./src/cb-popup-link-get-a-cash-offer/view.js ***!
  \****************************************************/
document.addEventListener("DOMContentLoaded", function () {
  const popupWrapper = document.querySelector(".cb-popup-link-get-a-cash-offer__wrapper");
  const links = popupWrapper.querySelectorAll(".cb-popup-link-get-a-cash-offer__link");
