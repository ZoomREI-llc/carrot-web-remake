...
$background_image_url = esc_url(plugins_url('src/cb-oc-page-hero/assets/background-' . $selected_market . '.webp', dirname(__FILE__, 2)));
$carrot_hero_url = esc_url(plugins_url('src/cb-oc-page-hero/assets/carrot-hero.webp', dirname(__FILE__, 2)));
?>
...
<section class="cb-oc-page-hero-wrapper">
    <svg class="cb-oc-page-hero__triangle top" viewBox="0 0 100 100" preserveAspectRatio="none">
        <polygon points="0,0 100,0 0,100" />
    </svg>

    <div class="cb-oc-page-hero">
        <div class="cb-oc-page-hero__top">
            <div class="cb-oc-page-hero__call-us">
                Call Us! <a href="tel:<?php echo $phoneNumber; ?>"><?php echo $phoneNumber; ?></a>
            </div>
            <a href="<?php echo site_url() ?>/get-a-cash-offer-today/" class="cb-oc-page-hero__top--nav-link">Get A Cash Offer Today</a>
        </div>
       
        <div class="cb-oc-page-hero__content">
        </div>
    </div>

    <svg class="cb-oc-page-hero__triangle bottom" viewBox="0 0 100 100" preserveAspectRatio="none">
