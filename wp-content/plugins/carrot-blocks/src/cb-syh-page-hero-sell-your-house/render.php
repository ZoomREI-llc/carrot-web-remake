...
<section class="cb-syh-page-hero-sell-your-house-section">
    <div class="cb-syh-page-hero-sell-your-house-wrapper">
        <svg class="cb-syh-page-hero-sell-your-house__triangle top" viewBox="0 0 100 100" preserveAspectRatio="none">
            <polygon points="0,0 100,0 0,100" />
        </svg>
        <div class="cb-syh-page-hero-sell-your-house">
            <div class="cb-syh-page-hero-sell-your-house__top">
                <div class="cb-syh-page-hero-sell-your-house__call-us">
                    Call Us! <a href="tel:<?php echo $phoneNumber; ?>"><?php echo $phoneNumber; ?></a>
                </div>
                <a href="<?php echo site_url() ?>/get-a-cash-offer-today/" class="cb-syh-page-hero-sell-your-house__top--nav-link">Get A Cash Offer Today</a>
            </div>
        </div>
        <div class="cb-syh-page-hero-sell-your-house__block-for-hight"></div>
        <svg class="cb-syh-page-hero-sell-your-house__triangle bottom" viewBox="0 0 100 100" preserveAspectRatio="none">
            <polygon points="0,100 100,100 100,0" />
        </svg>
    </div>
    <div class="cb-syh-page-hero-sell-your-house__content">
        <h1 class="">Sell Your House in <?php echo $market_name; ?> </h1>
        <div class="cb-syh-page-hero-sell-your-house__content--wrapper">
            <div class="cb-syh-page-hero-sell-your-house__content--column-left">
                <p class="">
                    <?php echo cb_get_responsive_image('cb-syh-page-hero-sell-your-house/step1', 'step 1', 'cb-syh-page-hero-sell-your-house__icon'); ?>
                ...
                <p class="">
                    <?php echo cb_get_responsive_image('cb-syh-page-hero-sell-your-house/step2', 'step 2', 'cb-syh-page-hero-sell-your-house__icon'); ?>
                ...
                <hr class="cb-syh-page-hero-sell-your-house__content--separator">
                <p class="">
                    <?php echo cb_get_responsive_image('cb-syh-page-hero-sell-your-house/step3', 'step 3', 'cb-syh-page-hero-sell-your-house__icon'); ?>
                    <strong>You choose a closing date when you will receive your cash.</strong>
                </p>
            </div>
            <div class="cb-syh-page-hero-sell-your-house__content--column-right">
                <div class="cb-syh-page-hero-sell-your-house__content--column-right--heading">
                ...
                <div class="cb-syh-page-hero-sell-your-house__content--column-right--form-wrapper">
