...
$background_image_url = esc_url(plugins_url('src/cb-compare-hero/assets/background-' . $selected_market . '.webp', dirname(__FILE__, 2)));
$carrot_hero_url = esc_url(plugins_url('src/cb-compare-hero/assets/carrot-hero.webp', dirname(__FILE__, 2)));
?>
