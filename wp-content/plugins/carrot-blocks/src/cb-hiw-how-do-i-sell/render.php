...
<section class="cb-hiw-how-do-i-sell__container">
    <div class="cb-hiw-how-do-i-sell">
        ...
        <p class="cb-hiw-how-do-i-sell__text">By using our vast knowledge about houses in all areas in <?php echo $selected_market; ?>, and by avoiding any 3rd parties (Agents, banks, inspectors etc.), we can offer cash for homes in <?php echo $selected_market; ?>, and provide a very quick offer so you can <a href="/sell-your-house">sell your house</a> fast for cash and make it a true hassle-free process for you.</p>
