...
<section class="cb-contact-page-hero-wrapper">
    <svg class="cb-contact-page-hero__triangle top" viewBox="0 0 100 100" preserveAspectRatio="none">
        <polygon points="0,0 100,0 0,100" />
    </svg>

    <div class="cb-contact-page-hero">
        <div class="cb-contact-page-hero__top">
            <div class="cb-contact-page-hero__call-us">
                Call Us! <a href="tel:<?php echo $phoneNumber; ?>"><?php echo $phoneNumber; ?></a>
            </div>
            <a href="<?php echo site_url() ?>/get-a-cash-offer-today/" class="cb-contact-page-hero__top--nav-link">Get A Cash Offer Today</a>
        </div>
       
        <div class="cb-contact-page-hero__content">
        </div>
    </div>

    <svg class="cb-contact-page-hero__triangle bottom" viewBox="0 0 100 100" preserveAspectRatio="none">
