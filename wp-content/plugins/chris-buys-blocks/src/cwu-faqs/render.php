<?php
$selectedMarket = get_blog_option(get_current_blog_id(), 'market_city', '');
$brandName = get_blog_option(get_current_blog_id(), 'company_name', '');
...
<section id='faq' class="cwu-faqs inter-font">
    <div class="grid-container">
        <div class="cwu-faqs__header">
            <span class="pre-title">FAQs</span>
            <h2 class="title-2">Frequently Asked <span>Questions</span></h2>
        </div>
        <div class="cwu-faqs__items">
            <?php foreach ($faqs as $faq) : ?>
                <div class="cwu-faqs__item">
                    <div class="faq-question cwu-faqs__question">
                        <?php echo esc_html($faq['question']); ?>
                        <span class="cwu-faq-indicator">+</span>
                    </div>
                    <div class="cwu-faqs__answer">
