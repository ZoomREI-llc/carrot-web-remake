...
<form id="<?= $short_id ?>" name="lead_form_v2" class="lead-form-multistep" data-submit-event="submitStep1" action="/wp-json/custom/v1/submit-form" method="POST" data-redirect="/step-2">
